...
├─────────────────────────┤                  ├──────────────────────────────────┤                  
│  Senzory:               │  LoRa (868 MHz)  │  • Príjem dát z LoRa             │         
│  - SEN-10245 (50 kg)    │ ───────────────> │  • Pripojenie na WiFi            │  ──┐
│  - BME 280              │                  │  • Konverzia dát na formát JSON  │    |     
└─────────────────────────┘                  └──────────────────────────────────┘    |             
                                                                                     |          
        ┌────────────────────────────────────────────────────────┐                   |
        ...
        │                      ThingsBoard                       │                   |
        │  ┌───────────────────────┐      ┌───────────────────┐  │                   |
        │  │     Dátová vrstva     │      │Prezentačná vrstva │  │     HTTP POST     |
        │  │ Integrovaná databáza  │ ───> │   Web Dashboard   │  │ <─────────────────┘
        │  │     (PostgreSQL)      │      │       Grafy       │  │    (Port 8080)
        │  └───────────────────────┘      └───────────────────┘  │
        └────────────────────────────────────────────────────────┘
```
---
